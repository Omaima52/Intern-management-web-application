                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Nombre des stages OBS</th>
                                                <th>Nombre des stages PRO</th>
                                                <th>Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                   ...
                                   while($row = $result1->fetch_assoc()) {
                                      ?>
                                            <tr>
                                                ...
                                                <td><?php echo $row['nbrStage_observation']; ?></td>
                                                <td><?php echo $row['nbrStage_pro']; ?></td>
                                            
                                        
                                                <td class="text-center">
                                                <a href="edit_service.php?idService=<?=$row['idService'];?>"><button type="button" class="btn btn-xs btn-primary" ><i class="fa fa-edit"></i></button></a>
