...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Gestion des Roles</h3>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="input-states">
                            <form class="form-horizontal" method="POST" action="actions/save_role.php" name="Niveauform" enctype="multipart/form-data">

                                <input type="hidden" name="currnt_date" class="form-control" value="">

                                <div class="form-group">
                                    <div class="row">
                                        <label class="col-sm-4 control-label text-right">Nom du role</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="nomRole" class="form-control" placeholder="Saisir le nom du role" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
